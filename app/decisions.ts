 ...
 * place, so every way of finishing reaches it — a board card, the task page,
 * a card of the unified board, focus mode — and a reload before the person
 * answers raises the same prompt again. See ADR-0010.
 */
