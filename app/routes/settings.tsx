...
import { changeSlug, slugify } from "../orgs.server";
...
export async function action({ request, context, params }: Route.ActionArgs) {
  ...
  // The same slug is no change, and the unique index would not complain.
  if (slug === scope.org.slug) return redirect(`/o/${slug}/settings`);

  const done = await changeSlug(env.DB, scope.org.id, slug);
