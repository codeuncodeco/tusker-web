-- The better-auth tables: user, session, account and verification.
-- Generated by `pnpm run auth:schema`, from the options in `app/auth.server.ts`.
-- Regenerate it after a better-auth upgrade or a plugin change.
